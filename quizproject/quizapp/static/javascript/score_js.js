function total_score(){
    var score = 0
    var q1 = document.getElementById('js_quiz1_q4')
    var q2 = document.getElementById('js_quiz2_q3')
    var q3 = document.getElementById('js_quiz3_q1')
    var q4 = document.getElementById('js_quiz4_q3')
    var q5 = document.getElementById('js_quiz5_q2')
    var q6 = document.getElementById('js_quiz6_q1')
    var q7 = document.getElementById('js_quiz7_q2')
    var q8 = document.getElementById('js_quiz8_q3')
    var q9 = document.getElementById('js_quiz9_q2')
    var q10 = document.getElementById('js_quiz10_q1')
